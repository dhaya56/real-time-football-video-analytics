...
The image below shows a representative frame from the final annotated output generated by the system.  
It demonstrates integrated player and ball detection, multi-object tracking, team assignment, possession identification, and motion-based analytics.

![Final Annotated Output](assets/final_output.png)
